...
export async function sendInvoiceEmail(data: InvoiceEmailData): Promise<{ success: boolean; error?: string }> {
  ...
  const mailOptions: nodemailer.SendMailOptions = {
    ...
    to: data.to,
    subject: `Faktura ${data.invoiceNumber} - SportFlow`,
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <p>Vedlagt finner du faktura for SportFlow-abonnementet ditt.</p>
          ...
          <p>Faktura er vedlagt som PDF. Vennligst betal innen forfallsdato.</p>
          
          <p>Har du spørsmål? Svar gjerne på denne e-posten.</p>
          
          <div class="footer">
            <p>Med vennlig hilsen,<br><strong>SportFlow</strong></p>
...
Vedlagt finner du faktura for SportFlow-abonnementet ditt.
